    ...
    <tr ng-repeat="post in posts">
      ...
      <td>
        <a ui-sref="detalle_estudio({id_estudio: post.ID_arribo})"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="bottom" title="Editar Puerto"></i></a>
          <a href="http://107.180.66.98:90//SAO/Views/Pages/excel.php?arribo=({post.ID_arribo})"><i class="fa fa-download" data-toggle="tooltip" data-placement="bottom" title="Descargar PDF"></i></a>
